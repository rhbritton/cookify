...
function Recipe() {
  ...
  console.log(_static_RecipeData__WEBPACK_IMPORTED_MODULE_4__["default"].recipes);
  console.log(router.query.id);
  console.log(_static_RecipeData__WEBPACK_IMPORTED_MODULE_4__["default"].recipes[router.query.id]);
  var title = _static_RecipeData__WEBPACK_IMPORTED_MODULE_4__["default"].recipes[router.query.id].title;
  var ingredients = _static_RecipeData__WEBPACK_IMPORTED_MODULE_4__["default"].recipes[router.query.id].ingredients;
  ingredients.forEach(function (ingredient_id, i) {
    ingredients[i].ingredient = _static_IngredientData__WEBPACK_IMPORTED_MODULE_5__["default"][ingredient_id];
  });
...
//# sourceMappingURL=recipe.js.1d3a9890bfc8dc803d6b.hot-update.js.map